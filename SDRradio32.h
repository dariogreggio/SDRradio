...
#define FCY 240000000UL    //Oscillator frequency; ricontrollato con baud rate, pare giusto così! (v. anche PLL)
...
#define Fosc		FCY
#define Fcy			(Fosc/2)
#define Fs   		3158000UL           // (2560000 questo dà 39 al timer, meno non va :( )
// overclock a 216, =>108 multiplo esatto di 2700000
// va a 30000000! 22/8/22 PR1=36, SAMC=3, 8bit, ADCDIV=1
// va a 32000000! 8/9/22 idem e overclock a 240MHz!
//   in effetti con 3158000 ottengo PR1=37.99 = 37 ed è ok
//   se metto 3157500 ho PR1=38 ma nonostante l'oscilloscopio confermi i 3.2MHz sul led, la frequenza mostrata è sbagliata di un 3-4% (sia FFT che tuning)
