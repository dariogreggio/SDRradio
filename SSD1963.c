...
void ResetDevice(void) {
	...
	DriverInterfaceInit();		// preso da SSD1926, è in gfxepmp.h
...
// è questo, K-Tronic 2018 320x240
	WriteCommand(CMD_SET_PCLK);
	DisplayEnable();
	WriteData(0x01);
	WriteData(0xdd);
...
*
* Note: anche questa sarebbe rimpiazzata in primitive.c, ma quella è lentissima...
*
********************************************************************/
#ifdef USE_DRV_BAR
...
// mmm si potrebbe mettere qua il controllo che se il file non c'è, salta!
		return;
